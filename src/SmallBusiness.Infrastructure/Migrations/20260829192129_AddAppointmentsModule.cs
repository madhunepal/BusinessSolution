    ...
    public partial class AddAppointmentsModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppointmentAssignments_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentAssignments_AppointmentId_UserId",
                table: "AppointmentAssignments",
                columns: new[] { "AppointmentId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BusinessId_Start",
                table: "Appointments",
